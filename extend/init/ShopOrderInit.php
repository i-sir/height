...
class ShopOrderInit extends Base
{
    ...
    //后台展示状态列表,统计数量
    public $status_list = [1 => '待付款', 2 => '已付款', 4 => '已发货', 6 => '已收货', 8 => '已完成', 10 => '已取消', 12 => '退款申请', 13 => '待退回', 14 => '退款驳回', 16 => '退款成功'];

    //后台状态,名字,条件
    public $admin_status       = [1 => '待付款', 2 => '待发货', 4 => '已发货', 6 => '已收货', 8 => '已完成', 10 => '已取消', 12 => '退款审核中', 13 => '待退回', 14 => '退款驳回', 16 => '退款成功'];
    public $admin_status_where = [1 => [1], 2 => [2], 4 => [4], 6 => [6], 8 => [8], 10 => [10], 12 => [12, 14, 16], 13 => [13], 14 => [14], 15 => [15], 16 => [16]];

    //前端状态,名字,条件
    public $api_status       = [1 => '待付款', 2 => '待发货', 4 => '已发货', 6 => '待评价', 8 => '已完成', 10 => '已取消', 12 => '退款审核中', 13 => '待退回', 14 => '退款驳回', 16 => '退款成功'];
    public $api_status_where = [1 => [1], 2 => [2, 20], 4 => [4], 6 => [6], 8 => [8], 10 => [10], 12 => [12, 14, 15, 16], 13 => [13]];
