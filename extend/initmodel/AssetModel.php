...
//        'point'   => '积分',
    ...
    public $order_type = [
        ...
        100  => '支付订单(余额)',
        110  => '订单退款增加(余额)',
        120  => '商城订单,直推邀请佣金增加(余额)',
        130  => '商城订单,间推邀请佣金增加(余额)',
        140  => '体验卡订单,间推邀请佣金增加(余额)',
        150  => '体验卡订单,间推邀请佣金增加(余额)',
        160  => '课程订单,间推邀请佣金增加(余额)',
        170  => '课程订单,间推邀请佣金增加(余额)',
        180  => '成为分销员,间推邀请佣金增加(余额)',
        190  => '成为分销员,间推邀请佣金增加(余额)',
